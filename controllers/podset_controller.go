...
import (
	...
	appv1alpha1 "github.com/hacktor/podset-operator/api/v1alpha1"
...
// +kubebuilder:rbac:groups=app.hacktor.com,resources=podsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=app.hacktor.com,resources=podsets/status,verbs=get;update;patch
